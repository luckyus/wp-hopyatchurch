...
(function (component, $) {
	...
	// debug
	console.log("media-poster-widget.js");
	...
	ImageWidgetControl = component.MediaWidgetControl.extend(
		/** @lends wp.mediaWidgets.controlConstructors.media_image.prototype */ {
			...
			renderPreview: function renderPreview() {
				...
				previewTemplate = wp.template("wp-media-widget-poster-preview");
				...
				if (!linkInput.is(document.activeElement)) {
					...
					fieldsTemplate = wp.template("wp-media-widget-poster-fields");
	...
	// Exports.
	component.controlConstructors.media_poster = ImageWidgetControl;
	component.modelConstructors.media_poster = ImageWidgetModel;
